...
function addDepotCard() {
	...
	var html = "<input id=\"payid\" name=\"payid\"  value=\"1\" hidden=\"hidden\"/>"
			+"<label>用户名：</label><div style=\"width: 30%;\">"
			+ "<div class=\"input-group\">"
			+ "<input id=\"username\" name=\"username\" placeholder=\"请输入用户名\" type=\"text\" class=\"form-control\">"
			+ "</div>"
			+ "</div>"
...
function rechargeDepotCard() {
	...
	$("#checkSubmit").html("充值");
	//$("#checkSubmit").attr("onclick","rechargeDepotCardSubmit()");
